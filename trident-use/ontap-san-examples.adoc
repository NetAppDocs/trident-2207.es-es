...
| `managementLIF` | Dirección IP de un LIF de gestión de SVM o clúster para una conmutación de sitios MetroCluster fluida, debe especificar una LIF de gestión de SVM. Esta característica es **avance técnico**. | “10.0.0.1”, “[2001:1234:abcd::fefe]” 
